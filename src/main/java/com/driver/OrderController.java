...
OrderService orderService;
    ...
    public ResponseEntity<String> addOrderPartnerPair(@RequestParam String orderId, @RequestParam String partnerId){
        ...
        catch (OrderIdNotPresentException ex)
        {
            return new ResponseEntity<>("OrderId not found",HttpStatus.NOT_FOUND);
        }
        catch (DeliveryPartnerNotPresentException ex)
        {
            return new ResponseEntity<>("Delivery partner is not found",HttpStatus.NOT_FOUND);
        }
    }
    ...
    public ResponseEntity<DeliveryPartner> getPartnerById(@PathVariable String partnerId){
        ...
        try {
            DeliveryPartner deliveryPartner = orderService.getPartnerByPartnerId(partnerId);
